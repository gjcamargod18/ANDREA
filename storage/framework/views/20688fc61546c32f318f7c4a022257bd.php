<div>
    ...
    <select id="rol" name="rol"
        ...
        <option selected value="0">Roles de usuario</option>
        <option value="1">Administrador</option>
        <option value="2">Administrador de prestamos</option>
        <option value="3">Instructor</option>
    </select>

</div>
<?php /**PATH C:\Users\ADSI\Documents\Project\sistema_llaves-main\resources\views/components/component-input-select.blade.php ENDPATH**/ ?>
...
<div>
    <!-- Main modal -->
    <div id="actualizar" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" method="POST" action="<?php echo e(route('actualizar')); ?>">
...
<?php /**PATH C:\Users\ADSI\Documents\Project\sistema_llaves-main\resources\views/components/actualizar-modal.blade.php ENDPATH**/ ?>
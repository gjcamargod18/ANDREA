      ...
      <div class="relative w-full max-w-2xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="p-6 space-y-6">
                <form class="space-y-6" method="POST" action="{{ route('crear-llave')}}">
                    @csrf
                    <div>
                        <div>
                                ...
                                <tbody>
                                    @foreach ($ambientes as $ambiente)
                                        <tr class="bg-white border-b dark:bg-white dark:border-gray-200">
                                            <td class="px-6 py-4">
                                                <input id="default-radio-1" type="radio" value="{{ $ambiente->id }}" id="id-ambiente" name="id-ambiente" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                <label for="default-radio-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $ambiente->nombre_ambiente }}</label>
